...
public class Panel_RegistrarVigilante extends javax.swing.JPanel {
    ...
    String contraseña = campo_contraseña.getText();
         ...
         if( cedula.equals("") || nombre.equals("") || apellido.equals("") || telefono.equals("") || correo.equals("") || fechaNacimiento.equals("") || contraseña.equals("")  ){
            Alerta ventana = new Alerta("Todos los campos son Obligatorios.");
        }else{
           // Encriptar la contraseña utilizando el método getMD5
             String contraseñaEncriptada = getMD5(contraseña);
  
              basedatos.insertarUsuario(cedula, nombre, apellido, correo, contraseñaEncriptada, telefono, fechaNacimiento);
